...
export declare function hardDenyReason(exec: Readonly<ToolExecution>, roots: PolicyRoots, locale?: UiLocale, mode?: ManagedMode): string | undefined;
/**
 * 工具级三级判定：
 ...
 */
export declare function assessTool(exec: Readonly<ToolExecution>, roots: PolicyRoots, locale?: UiLocale, mode?: ManagedMode): Assessment;
