...
var ApiSettingsSource = class {
  ...
  constructor(api, namespace) {
    ...
    this.store = (0, import_client.createSnapshotStore)({ status: "loading", writable: false, value: {}, user: {}, inherited: {}, revision: void 0 });
    void this.refresh();
  }
  async refresh() {
    ...
    try {
      ...
      const view = result.value.namespaces.find((candidate) => String(candidate.ns) === this.namespace);
      if (view === void 0) {
